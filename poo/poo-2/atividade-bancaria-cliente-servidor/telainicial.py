...
class TelaInicial(object):
    def setupUi(self, MainWindow):
        ...
        self.labelWelcome.setGeometry(QtCore.QRect(210, 40, 231, 41))
        font = QtGui.QFont()
        ...
        self.labelUser.setGeometry(QtCore.QRect(290, 90, 61, 41))
        font = QtGui.QFont()
        ...
        self.labelSenha.setGeometry(QtCore.QRect(290, 170, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEditUser.setGeometry(QtCore.QRect(240, 130, 171, 21))
        self.lineEditUser.setObjectName("lineEditUser")
        self.lineEditSenha = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEditSenha.setGeometry(QtCore.QRect(240, 210, 171, 21))
        self.lineEditSenha.setObjectName("lineEditSenha")
        self.btnLogin = QtWidgets.QPushButton(self.centralwidget)
        self.btnLogin.setGeometry(QtCore.QRect(280, 250, 91, 31))
        ...
        self.btnCadastrar.setGeometry(QtCore.QRect(280, 290, 91, 31))
